      ...
      <b-card no-body class="mb-0">
         ...
         <b-table ref="refTable" :items="fetchData" responsive :fields="tableColumns" primary-key="id"
               ...
               <b-container fluid class="content-toggle-table">
                  <b-row>
                     <b-col cols="12" md="6">
                        <table class="table table-hover table-sm">
                           ...
                           <tr>
                              ...
                              <td> <strong class="text-nowrap"> {{ item.contenedor.contenedor.numero }}</strong></td>
                           </tr>
                           ...
                           <tr>
                              <td class="text-black">Vessel:</td>
                              <td>
                                 <strong class="text-nowrap">
                                    {{ item.contenedor.vessel ? item.contenedor.vessel : 'Sin definir' }}
                                 </strong>
                              </td>
                           </tr>
                     ...
                     <b-col cols="12" md="6">
                        ...
                        <vue-perfect-scrollbar class="scroll-area" :settings="{maxScrollbarLength:500}">
                           <app-timeline>
                              <app-timeline-item icon="MapPinIcon" v-for="(estatus, i ) in item.statuses" :key="i">
                                 ...
                                 <div
                                    ...
                                    <small class="text-muted">{{ estatus.created_at | fecha('D/MM/YYYY h:mm a')
                                    }}</small>
                                 </div>
            ...
            <template #cell(status)="{item}">
               <b-button :to="{name:'reportes.show.status',params:{id:item.id}}" title="Mostrar Estatus" plain size="sm"
            ...
            <template #cell(contenedor)="{item}">
               <strong class="text-nowrap"> {{ item.contenedor.contenedor.numero }}</strong>
            </template>

            <template #cell(destino)="{item}">
               <strong class="text-nowrap "> {{ item.destino.destino }}</strong>
            </template>
            ...
            <template #cell(actions)="{ item }">
               ...
               <b-button-group size="sm">
                  ...
                  <b-button variant="primary" title="Ver orden de entrega"
                     :to="{name:'reportes.show.orden',params:{id:item.orden.id}}" v-if="$can('read', 'ordenes') && item.orden">
                     <feather-icon icon="EyeIcon" />
                  </b-button>

                  <b-button variant="secondary" title="Información Adicional" @click="mostrarInformacionAdicional(item)"
                  ...
                  <b-button variant="dark" title="Comentarios" @click="showComentarios(item)"
                     v-if="$can('write', 'comentarios')">
                     <feather-icon icon="MessageSquareIcon" />
                  </b-button>

                  <b-button variant="warning" title="Archivos" :to="{name:'reportes.listar.archivos',params:{id:item.id}}"
                     v-if="$can('write', 'archivos')">
                     ...
                     <b-form @submit.prevent="handleSubmit(guardar)">
                        ...
                        <b-form-group>
                           ...
                           <validation-provider name="hora" #default="{errors}">
                              <flat-pickr v-model="formulario.hora" class="form-control"
                                 :config="{ dateFormat: 'H:i', enableTime:true,noCalendar:true}" placeholder="00:00" />
                              <b-form-invalid-feedback :state="errors.length ? false : null">
                                 {{ errors[0] }}
                              </b-form-invalid-feedback>
                     ...
                     <b-form @submit.prevent="handleSubmit(guardarInformacionAdicional)">
                        ...
                        <b-form-group>
                           ...
                           <validation-provider name="po" #default="{errors}">
                              ...
                              <b-form-input v-model="entrega.informacion_adicional.po"
                        ...
                        <b-form-group>
                           ...
                           <validation-provider name="invoice" #default="{errors}">
                              ...
                              <b-form-input v-model="entrega.informacion_adicional.invoice"
                                 :state="errors.length ? false : null" />
                        ...
                        <b-form-group>
                           ...
                           <validation-provider name="sales_order" #default="{errors}">
                              ...
                              <b-form-input v-model="entrega.informacion_adicional.sales_order"
                                 :state="errors.length ? false : null" />
                        ...
                        <b-form-group>
                           ...
                           <validation-provider name="shipment" #default="{errors}">
                              ...
                              <b-form-input v-model="entrega.informacion_adicional.shipment"
                                 :state="errors.length ? false : null" />
